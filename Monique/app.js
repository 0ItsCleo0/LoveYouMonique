...
function pageTrans(direction) {
    ...
    if (direction == 'Open') {
        ...
        pageOpen
            ...
            .fromTo('#timeline', {height: 'fit-content'}, {height: '100vh', duration: 0})
            ...
            .fromTo(date + ' p', {margin: '-15em 0', height: 0}, {margin: '0 0', height: '6em', duration: 0.6, delay: 0.1})
            ...
            .fromTo(date + ' svg', {stroke: '#1f1f1f00'}, {stroke: '#1f1f1f', duration: 1})
    } else {
        pageClose.play()
        ...
        pageClose
            ...
            .fromTo(date + ' p', {margin: '0 0', height: '6em'}, {margin: '-15em 0', height: 0, duration: 0.5})
            ...
            .fromTo('#timeline', {height: '100vh'}, {height: 'fit-content', duration: 1})
            .fromTo(date, {zIndex: 2}, {zIndex: -10, duration: 1}, '-=0.8')
    }
}
...
//     if (pageOpen.isActive()) { return }

//     pageOpen.play()

//     var rule = CSSRulePlugin.getRule(".date-content h1::after");
//     var rule2 = CSSRulePlugin.getRule(".date-content ul h1::after");
//     console.log(date + " h1::after");
